 ...
 */
function bubulla_get_featured_posts() {
	
	/**
	 * @param array|bool $posts Array of featured posts, otherwise false.
	 */
	return apply_filters( 'bubulla_get_featured_posts', array() );
}
 ...
 */ 
if ( ! function_exists( 'bubulla_the_attached_image' ) ) {

	function bubulla_the_attached_image() {
		$post = get_post();
		/**
		 ...
		 * }
		 */
		$attachment_size     = apply_filters( 'bubulla_attachment_size', array( 810, 810 ) );
 ...
 */
if ( ! function_exists( 'bubulla_list_authors' ) ) {

	function bubulla_list_authors() {
					...
					<div class="contributor-summary">
						...
						<a class="button contributor-posts-link"
						   href="<?php echo esc_url( get_author_posts_url( $contributor_id ) ); ?>">
							<?php printf( _n( '%d Article', '%d Articles', $post_count, 'bubulla' ), $post_count ); ?>
						</a>
					</div>
					<!-- .contributor-summary -->
				</div>
 ...
 */ 
if ( ! function_exists( 'bubulla_paging_nav' ) ) {

	function bubulla_paging_nav( $wp_query = null ) {
		...
		<nav class="navigation paging-navigation">
			<h3 class="screen-reader-text"><?php echo esc_html__( 'Posts navigation', 'bubulla' ); ?></h3>
 ...
 */
if ( ! function_exists( 'bubulla_post_nav' ) ) {
 ...
 */
function bubulla_categorized_blog() {

	if ( false === ( $all_the_cats = get_transient( 'bubulla_category_count' ) ) ) {
		...
		set_transient( 'bubulla_category_count', $all_the_cats );
	}
